...
public class AbBottomTabView extends LinearLayout {
	...
	/** tab的文字颜色. */
	private int tabTextColor = Color.BLUE;
	
	/** tab的选中横线颜色. */
	private int tabSelectColor = Color.TRANSPARENT;
	...
	public AbBottomTabView(Context context, AttributeSet attrs) {
		...
		//定义Tab栏
  		...
  		tabItemTextList = new ArrayList<>();
  		tabItemDrawableList = new ArrayList<>();
	 ...
	 * @param fragment the fragment
	 */
	public void changeItemView(int index,Fragment fragment){
		pagerItemList.set(index, fragment);
		mFragmentPagerAdapter.notifyDataSetChanged();
		notifyTabDataSetChanged();
	}
