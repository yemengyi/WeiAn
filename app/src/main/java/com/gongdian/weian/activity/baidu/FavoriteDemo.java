...
public class FavoriteDemo extends Activity implements OnMapLongClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.baidu_favorite_activity);
        // 初始化地图
    ...
    public void initUI() {
        ...
        mPop = (View) mInflater.inflate(R.layout.baidu_activity_favorite_infowindow, null, false);
    }
    ...
    public void modifyClick(View v) {
        ...
        // 弹框修改
        LayoutInflater mInflater = getLayoutInflater();
        mModify = (LinearLayout) mInflater.inflate(R.layout.baidu_favorite_alert, null);
