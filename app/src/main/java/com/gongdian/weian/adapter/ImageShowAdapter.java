...
public class ImageShowAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			mImageView2.setMaxWidth(20);
			mImageView2.setMaxHeight(20);
		...
		if(imagePath.indexOf("http://")!=-1) {
			holder.mImageView2.setBackgroundResource(R.drawable.photo_selected);
		}
	 ...
	 * @param imagePaths the image paths
	 */
	public void addItem(int position,int maxPosition,String imagePaths) {
