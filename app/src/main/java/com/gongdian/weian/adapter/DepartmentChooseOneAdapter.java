...
public class DepartmentChooseOneAdapter extends BaseAdapter {
     ...
     * @param list    列表展现的数据
     */
    public DepartmentChooseOneAdapter(Context context, List<Department> list) {
        mContext = context;
        mList = list;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.itemsCheck.setChecked(department.isChoose());
        //设置开关的监听
