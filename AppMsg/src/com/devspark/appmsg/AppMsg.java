...
//        view.setBackgroundResource(style.background);
        ...
        if (style.background == R.color.alert) {
            tv.setBackgroundResource(R.drawable.back_alter);
        }else if(style.background == R.color.info){
            tv.setBackgroundResource(R.drawable.back_info);
        }else if(style.background == R.color.confirm){
            tv.setBackgroundResource(R.drawable.back_confirm);
        }
